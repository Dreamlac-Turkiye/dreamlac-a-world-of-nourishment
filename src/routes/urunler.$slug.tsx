    ...
    <main id="main" className="overflow-hidden pb-20">
      <section className="relative bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <nav
            ...
            className="py-5 text-[0.7rem] font-semibold text-muted-foreground uppercase"
          >
          ...
          <div className="grid min-h-[calc(100svh-9rem)] gap-10 pb-10 lg:grid-cols-12 lg:items-center lg:gap-20 lg:pb-16">
            <div className={cn("grain relative lg:col-span-7", stageBg[product.stage])}>
              <div
                aria-hidden="true"
              ...
              <div className="relative aspect-[5/4] overflow-hidden rounded-[2rem] border border-card/70 bg-card/45 shadow-[var(--shadow-deep)] sm:aspect-[6/5] lg:aspect-[5/6] lg:max-h-[690px]">
                ...
                <div className="hero-product-enter relative mx-auto h-full w-[76%] p-8 sm:w-[68%] sm:p-12 lg:w-[78%] lg:p-16">
                  <PackShotPlaceholder
                    product={product}
                    className="animate-float-product"
                    priority
                  />
                </div>
            ...
            <div className="min-w-0 lg:col-span-5 lg:py-10">
              ...
              <ul className="mt-8 grid grid-cols-2 gap-3">
                {product.formulaFeatures.slice(0, 2).map((item) => (
                  <li
                    key={item}
                    className="flex min-h-24 flex-col justify-between rounded-lg border border-border/70 bg-card p-4 shadow-[var(--shadow-soft)]"
                  >
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6">
        <div className="flex items-end justify-between gap-4">
          <h2 className="max-w-lg text-2xl font-medium text-primary-deep sm:text-3xl">
            {tr.productDetail.relatedTitle}
          </h2>
          <span className="hidden text-xs font-semibold text-muted-foreground uppercase sm:block">
            Dreamlac 1 · 2 · 3
          </span>
        </div>
